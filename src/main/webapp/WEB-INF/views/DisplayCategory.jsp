...
<jsp:include page="AdminHeader.jsp"></jsp:include>
  ...
  <form:form commandName="editCategory">
...
Search:<input type=text placeholder="Search" ng-model="searchText"/>
  ...
  <div id="headin2" align="justify"><strong> <h3>CATEGORY DETAILS </h3></strong></div>
  <table width=\"100%\" border=\"0\" id=\"tab\">
  <tr>
    <th id=\"td1\"> CATEGORY ID	</th>
    <th id=\"td2\">	CATEGORY NAME	</th>
